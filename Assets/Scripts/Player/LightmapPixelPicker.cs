using UnityEngine;
 ...
 public class LightmapPixelPicker : MonoBehaviour {
	 ...
	 public float brightness2; // http://www.nbdtech.com/Blog/arc$$anonymous$$ve/2008/04/27/Calculating-the-Perceived-Brightness-of-a-Color.aspx
	...
	//	 if (Physics.Raycast(ray, out $$anonymous$$tInfo, 5f, layerMask))
	//	 {
	//		 // GET RENDERER OF OBJECT HIT
	//		 Renderer $$anonymous$$tRenderer = $$anonymous$$tInfo.collider.GetComponent<Renderer>();
  
	//		 // GET LIGHTMAP APPLIED TO OBJECT
	//		 LightmapData lightmapData = LightmapSettings.lightmaps[$$anonymous$$tRenderer.lightmapIndex];
  
	//		 // STORE LIGHTMAP TEXTURE
	//		 Texture2D lightmapTex = lightmapData.lightmapColor;
  
	//		 // GET LIGHTMAP COORDINATE WHERE RAYCAST HITS
	//		 Vector2 pixelUV = $$anonymous$$tInfo.lightmapCoord;
  
	//		 // GET COLOR AT THE LIGHTMAP COORDINATE
	//		 Color surfaceColor = lightmapTex.GetPixelBilinear(pixelUV.x, pixelUV.y);
  
	//		 // APPLY
	//		 t$$anonymous$$s.surfaceColor = surfaceColor;
	//	 }
	// }
